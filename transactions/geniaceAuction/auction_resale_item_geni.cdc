...
transaction(
    ...
    prepare(account: AuthAccount) {
        ...
        self.geniReceiverSeller = account.getCapability<&Geni.Vault{FungibleToken.Receiver}>(/public/geniReceiver)!
        self.geniReceiverCreator = getAccount(royaltyAccount).getCapability<&Geni.Vault{FungibleToken.Receiver}>(/public/geniReceiver)!
        self.geniReceiverPlatformOwner = getAccount(platformAccount).getCapability<&Geni.Vault{FungibleToken.Receiver}>(/public/geniReceiver)!
        
        assert(self.geniReceiverSeller.borrow() != nil, message: "Missing or mis-typed Geni receiver")
