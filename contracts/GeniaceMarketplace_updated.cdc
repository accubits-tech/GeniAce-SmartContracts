...
pub contract GeniaceMarketplace {
    ...
    pub event OfferPriceUpdated(saleOfferResourceID: UInt64, storefrontResourceID: UInt64, updatedPrice: UFix64)
    ...
    pub struct SaleOfferDetails {
        ...
        // updatePrice
        //
        access(contract) fun updatePrice(updatedPrice: UFix64) {
            self.salePrice = updatedPrice
        }
        ...
        init (
            ...
            for cut in self.saleCuts {
                ...
                percentageValue = percentageValue + cut.percentage
            }
            assert(percentageValue <= 1.0, message: "Total percentage value cannot exceed 100%")
    ...
    pub resource SaleOffer: SaleOfferPublic {
        ...
        pub fun accept(payment: @FungibleToken.Vault): @NonFungibleToken.NFT {
            ...
            for cut in self.details.saleCuts {
                ...
                let amount=self.details.salePrice*cut.percentage
        ...
        // Update saleprice
        pub fun updateOfferPrice( updatedPrice: UFix64){
                self.details.updatePrice(updatedPrice: updatedPrice)
